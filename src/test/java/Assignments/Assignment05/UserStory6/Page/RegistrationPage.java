package Assignments.Assignment05.UserStory6.Page;
...
public class RegistrationPage extends BasePage {
    ...
    public Assignments.Assignment05.UserStory6.Page.RegistrationPage fillAllFields(String usernameValue , String emailValue) {
        ...
        safeSendKeys(username, usernameValue);
        safeSendKeys(email, emailValue);
        safeSendKeys(password, "Lama@1234");
